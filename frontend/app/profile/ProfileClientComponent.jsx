...
export default function ProfileClientComponent({ userData, token }) {
  ...
  return (
    <div className="flex gap-[4%] mt-[2.5%] text-white ">
      <div className="border-[#DB7038] flex h-full border-t-2 border-r-2 border-b-2 rounded-r-[20px] shadow-custom w-[21%] items-center flex flex-col gap-6 py-[2.5%] px-3 bg-[#44444461]">
        <button
      ...
      {activeBlock === "block1" && (
        <>
          <div className="border-[#DB7038] border-2 rounded-l-[20px] flex flex-col shadow-custom w-[29%] py-[2.5%] items-center bg-[#44444461]">
            <div>
      ...
      {activeBlock === "block2" && (
        <div className="w-[73%] items-center border-[#DB7038] border-[1px] rounded-[10px] flex-col px-[3%] shadow-custom bg-[#313131]">
                ...
                <table className="table-auto w-full border-collapse">
                  ...
                  <tbody>
                    <tr className="border-b border-gray-700 hover:bg-gray-800">
                      ...
                      <td className="py-3 px-4">Соревнование-1</td>
                      <td className="py-3 px-4">Брянская область</td>
