...
export default function EventForAll() {
  ...
  return (
    <div className="text-white">
      ...
      <p className="text-[40px] underline text-white text-center">
        Результаты мероприятия
      </p>
      <div className="flex items-center vertical-center ml-[20%] mt-[2%] gap-4">
        <Image src="/superadminfile.png" alt="results" width={50} height={50} />
        <a href="" className="text-[25px] text-[#DB7038]">Нажмите чтобы посмотреть</a>
      </div>
    </div>
  );
}
